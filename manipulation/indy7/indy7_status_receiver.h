...
/// Handles lcmt_indy7_status messages from a LcmSubscriberSystem.
///
...
/// systems::lcm::LcmSubscriberSystem::Make<lcmt_indy7_status>().
///
/// This system has one abstract-valued input port of type lcmt_indy7_status.
///
...
/// for the finger joints in the Indy7 description (see indy7_constants.h.)
//
/// @system
/// name: Indy7StatusReceiver
/// input_ports:
/// - lcmt_indy7_status
/// output_ports:
/// - position_measured
...
class Indy7StatusReceiver : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(Indy7StatusReceiver)

  Indy7StatusReceiver(int num_joints = kIndy7DefaultArmNumJoints,
 ...
 private:
  template <std::vector<double> drake::lcmt_indy7_status::*,
            std::vector<double> drake::lcmt_indy7_status::*,
            int>
