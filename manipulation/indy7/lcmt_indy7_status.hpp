...
#ifndef __drake_lcmt_indy7_status_hpp__
#define __drake_lcmt_indy7_status_hpp__
...
/**
 * The current status of a Kinova indy7 arm.  All angular
 * positions/velocities are expressed in radians and radians/second.
 */
class lcmt_indy7_status
{
    public:
        /**
...
int lcmt_indy7_status::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_indy7_status::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lcmt_indy7_status::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lcmt_indy7_status::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lcmt_indy7_status::getTypeName()
{
    return "lcmt_indy7_status";
}

int lcmt_indy7_status::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_indy7_status::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int lcmt_indy7_status::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t lcmt_indy7_status::_computeHash(const __lcm_hash_ptr *)
{
